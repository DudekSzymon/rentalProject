...
const MyRentals = () => {
    ...
    // Sprawdzanie uwierzytelnienia z opóźnieniem
    useEffect(() => {
        ...
        }, 100); // Krótkie opóźnienie aby kontekst się załadował
    ...
    }, [user, filter, currentPage, authChecked]);
        ...
        return (
            <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 to-gray-100">
                <div className="text-center bg-white rounded-2xl p-12 border border-gray-200 shadow-sm">
                    ...
                    <p className="text-gray-900 text-lg font-medium">Sprawdzanie uwierzytelnienia...</p>
                        ...
                        <div className="flex items-center justify-between">
                            <div className="flex items-center space-x-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-600">Historia i status twoich wypożyczeń</p>
                                </div>
                            </div>
                            ...
                            <div className="text-right bg-white shadow-sm rounded-2xl p-4 border border-gray-200">
                                ...
                                <p className="text-gray-600 text-xs">Zarządzaj swoimi wypożyczeniami</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    {loading ? (
                        <div className="flex items-center justify-center py-20">
                            <div className="text-center bg-white rounded-2xl p-12 border border-gray-200 shadow-sm">
                                ...
                                <p className="text-gray-900 text-lg font-medium">Ładowanie wypożyczeń...</p>
                                <p className="text-gray-600 text-sm mt-2">Pobieramy najnowsze dane</p>
                            </div>
                        </div>
                    ) : error ? (
                        <div className="text-center py-20">
                            <div className="bg-red-50 border border-red-200 rounded-2xl p-8 max-w-md mx-auto">
                                ...
                                <h3 className="text-red-700 font-semibold text-lg mb-2">Wystąpił błąd</h3>
                        ...
                        <div className="text-center py-20">
                            <div className="bg-white rounded-2xl p-12 max-w-lg mx-auto border border-gray-200 shadow-sm">
                                ...
                                <h3 className="text-2xl font-bold text-gray-900 mb-4">Brak wypożyczeń</h3>
                                                ...
                                                <div className="flex items-center justify-between">
                                                    <div className="flex-1">
                                                        <div className="flex items-center space-x-4 mb-4">
                                                            ...
                                                            <div className={`flex items-center space-x-2 px-4 py-2 rounded-xl text-sm font-medium border ${status.color}`}>
                                                        ...
                                                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-sm">
                                                            <div className="bg-blue-50 rounded-xl p-4 border border-blue-100 group-hover:bg-blue-100 transition-all">
                                                                <div className="flex items-center space-x-3">
                                                                    ...
                                                                    <div>
                                                                        <p className="text-gray-900"><strong>Od:</strong> {formatDate(rental.start_date)}</p>
                                                                        <p className="text-gray-900"><strong>Do:</strong> {formatDate(rental.end_date)}</p>
                                                                        <p className="text-blue-600 text-xs font-medium">{duration} dni</p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div className="bg-green-50 rounded-xl p-4 border border-green-100 group-hover:bg-green-100 transition-all">
                                                                <div className="flex items-center space-x-3">
                                                                    ...
                                                                    <div>
                                                                        <p className="text-gray-900"><strong>Koszt:</strong> {rental.total_price} zł</p>
                                                            ...
                                                            <div className="bg-orange-50 rounded-xl p-4 border border-orange-100 group-hover:bg-orange-100 transition-all">
                                                                <div className="flex items-center space-x-3">
                                                                    ...
                                                                    <div>
                                                                        <p className="text-gray-900"><strong>Ilość:</strong> {rental.quantity || 1}</p>
                                                        ...
                                                        {rental.notes && (
                                                            <div className="mt-4 p-4 bg-gray-50 rounded-xl border border-gray-200">
                                                                <p className="text-gray-900 text-sm">
                                                                    <strong className="text-blue-600">Notatki:</strong> {rental.notes}
                                                                </p>
                                                            </div>
                                                        )}
                                                    </div>
